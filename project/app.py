...
class Application(Funcs, Relats):
    ...
    def widgetsFrame1(self):
        ...
        self.bt_canvas.place(relx=0.19, rely=0.08,
                             relwidth=0.23, relheight=0.19)
        # botão Limpar;
        ...
        self.entryCodigo = Entry(
            self.aba1, font=font_input, bg='#e0ffff', fg='#000')
        self.entryCodigo.place(relx=0.05, rely=0.165,
        ...
        self.entryNome = Entry(self.aba1, font=font_input,
                               bg='#e0ffff', fg='#000')
        self.entryNome.place(relx=0.04, rely=0.45,
                             relwidth=0.75, relheight=0.115)
        ...
        self.entryTelefone = Entry(
            self.aba1, font=font_input, bg='#e0ffff', fg='#000')
        self.entryTelefone.place(relx=0.04, rely=0.75,
                                 relwidth=0.38, relheight=0.115)
        ...
        self.entryCidade = Entry(
            self.aba1, font=font_input, bg='#e0ffff', fg='#000')
        self.entryCidade.place(relx=0.58, rely=0.75,
                               relwidth=0.38, relheight=0.115)

    def listaFrame2(self):
        self.style = ttk.Style()
        self.style.configure("mystyle.Treeview", bd=1, font=(
            'Alef', 11))  # Modify the font of the body
        self.style.configure("mystyle.Treeview.Heading", font=(
            'Alef', 11, 'bold'))  # Modify the font of the headings
        ...
        self.listaUser.place(relx=0.01, rely=0.05,
                             relwidth=0.95, relheight=0.88)

        self.scrollLista = Scrollbar(self.frame2, orient='vertical')
        self.listaUser.configure(yscroll=self.scrollLista.set)
        self.scrollLista.place(relx=0.96, rely=0.05,
                               relwidth=0.035, relheight=0.88)
    ...
    def Menus(self):
        ...
        filemenu2.add_command(label='Ficha do cliente',
                              command=self.geradorRelatCliente)
